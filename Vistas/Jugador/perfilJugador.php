        ...
        <div class="row">
            <nav class="col-e-2 col-o-2 col-t-12 col-m-12">
                <form action="../../Controlador/controlador_jugador.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-e-12">
                            <input class="col-e-12 button-primary" type="submit" name="editarPerfil"
                    ...
                    <div class="row">
                        <div class="col-e-12">
                            <input class="col-e-12 button-primary" type="submit" name="ranking"
                    ...
                    <div class="row">
                        <div class="col-e-12">
                            <input class="col-e-12 button-primary" type="submit" name="jugadoresOnline"
                ...
                <form action="../../Controlador/registro_IS.php" method="POST">
                    <div class="row">
                        <div class="col-e-12">
                            <input class="col-e-12 button-primary" type="submit" name="cerrarSesion"
            ...
            <section class="col-e-10 col-o-10 col-t-12 col-m-12 sectionRanking padTop padBottom">
                <div class="row">
                    <fieldset
