...
<body>
    ...
    <div class="container">
        ...
        <div class="row sectionRanking alturaDiv">
            <div class="col-e-12">
                <section class="row sectionRanking padTop">
                    <div class="col-e-12">
                        <?php
                            foreach($vectorUsuarios as $i => $usuario){
                                if($i % 2 == 0){
                                    $cad= '<div class="row padTop">
                                                <div class="colorClaroOnline col-e-4 col-o-8 col-t-10 col-m-10 offset-e-4 offset-m-1 offset-o-2 offset-t-1">
                                                    <div class="row">
                                    ...
                                    $cad ='<div class="row padTop">
                                                <div class="colorOscuroOnline col-e-4 col-o-8 col-t-10 col-m-10 offset-e-4 offset-m-1 offset-o-2 offset-t-1">
                                                    <div class="row">
                                                        <div class="col-e-1 col-o-1 col-t-1 col-m-1 centrado padBottom15">';
                                                            if($usuario->getEstado() == 0){
                                                                $cad .= '<input type="button" class="desconectado" disabled>';
                        ...
                        <div class="row padTop padBottom30">
                            <div class="col-e-2 col-o-12 col-t-10 col-m-10 offset-e-5 offset-m-1 offset-o-1 offset-t-1">
                                <div class="row">
                                    <a href="perfilJugador.php" class="col-e-12 col-m-12 button buttonSecundario">Volver
                                        a mi perfil</a>
                                </div>
                            </div>
                        </div>
