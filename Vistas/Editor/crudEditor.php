    ...
    <div class="container">
        ...
        <section class="sectionEditor">
            <div class="row">
                <div class="col-e-12">
                    <div class="row">
                        <nav class="col-e-5 col-m-12 col-t-12 offset-e-4 offset-m-0 offset-t-0">
                            <div class="row">
                ...
                <div class="col-e-12">
                    <?php
                        foreach($vectorEnigmas as $enigma){
                            $cad =  '<div class="row">
                                        <div class="etiquetaEnigma col-e-5 col-m-12 col-t-12 offset-e-4 offset-m-0 offset-t-0 padTarjeta">
